...
![훈련 적용 성과 — KPI Before/After](docs/screenshots/08-kpi-hexa.png)

**측정 적용기간**: 2026.04.13 ~ 04.30 (18일) · 사내 카톡 1,342건 텍스트 분석 + 본인 시간기록 기반 실측치

| KPI | Before | After | 개선율 |
|-----|--------|-------|--------|
| 업무 1건당 문서화 시간 | 35분 | **5분** | **−85.7%** |
| 의사결정권자 인지 지연 | 평균 2일 | **5분 미만** | **−99%** |
| 동일 정보 재질의 빈도 | 주 10회 | **주 1회** | **−90%** |
| 월간 업무 누락 건수 | 월 2.5건 | **0건** | **−100%** |
| 주간 업무보고 작성 시간 | 220분 | **30분** | **−86.4%** |
...
- 본 프로젝트는 **2026년 지역산업맞춤형인력양성사업 업무 적용 우수사례 공모전(주관: 경기도경제과학진흥원, GBSA)** **🏆 최우수상 수상작**의 사내 적용 산출물입니다. (2026-05-12 발표)
  - 출품작명: 「OMNIS」 — AI 노코드 활용 학습으로 만든 채팅 기반 업무관리 시스템: 문서화 병목과 의사결정 가시성 부재를 동시에 해소한 30일의 기록
