...
| [troubleshootings/pr-traps-2026-09.md](troubleshootings/pr-traps-2026-09.md) | reference | PR #7~#17 에서 밟은 함정 (next start 운영 DB 사고 · zoom 좌표계 · 늦게 끝난 AI 재구성 · MCP GET 재연결 루프 · 요청 한도) |
